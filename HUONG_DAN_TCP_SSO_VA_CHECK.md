...
Chỉ khi server từ chối rõ ràng tại `LOGIN` mới kết luận `FAIL / Sai pass`. Login thành công trả về UID và `session_key` TCP dài 16 byte.
...
- `FAIL / Sai pass`: chỉ khi TCP `LOGIN` bị từ chối rõ ràng.
